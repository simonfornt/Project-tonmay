        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <ul className="flex flex-col md:flex-row items-center gap-6">
              ...
              <li><Link to="/team" className="hover:text-gray-300 transition-colors">Team</Link></li>
            ...
            <Link 
              to="/login" 
              className="bg-white text-blue-600 px-4 py-2 rounded-lg font-semibold shadow-md hover:bg-gray-100 transition-colors"
            >
              Login
            </Link>
          </div>
