...
const supportItems = [
  {
    ...
    amount: 300,
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLGm8mosfmSGjZloL3Gf1MtS7p276sG7JNPA&s",
  },
  {
    id: 2,
    ...
    amount: 500,
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbRC9jVtKlUvxpkisY-aw5s7HyFaQAXFuArg&s",
  },
  {
    id: 3,
    name: "Food & Nutrition",
    amount: 200,
    image:
      "https://pbs.twimg.com/media/GmeDR3maIAAd5Li?format=jpg&name=4096x4096",
  },
  {
    id: 4,
    ...
    amount: 600,
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-U2gtoizxFXjtSEBJNYL6pmdtJZ-05ERaLg&s",
  },
];
        ...
        {supportItems.map((item) => (
          ...
          >
            ...
            <div className="text-center p-4">
              ...
              <p className="text-orange-400 font-semibold my-2">
                ${item.amount}
              </p>
              <button
