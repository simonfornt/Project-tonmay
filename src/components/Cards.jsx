    ...
    <div className="w-11/12 mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-6">
        {cardData.map((card) => (
          <div
            key={card.id}
            className="bg-white rounded-xl overflow-hidden shadow-xl border border-gray-200 hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out"
          >
