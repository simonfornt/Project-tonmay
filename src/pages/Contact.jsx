...
function Contact() {
  return (
    <div className='max-w-7xl mx-auto min-h-screen flex flex-col justify-center items-center px-4 py-16 '>
      <h2 className='text-3xl font-normal text-gray-700 mb-8 font-domine '>Contact Us</h2>
      <div className='flex gap-10 items-center justify-center w-full'>
        <div>
        <div className='bg-white p-8 rounded-lg w-full max-w-lg text-center border border-gray-200 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>
